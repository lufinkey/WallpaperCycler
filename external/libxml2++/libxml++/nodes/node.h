...
public:
   ...
   * @newin{2,36}
   */
  const Node* get_first_child(const std::string& name = std::string()) const;
   ...
   * @newin{2,36}
   */
  Node* get_first_child(const std::string& name = std::string());
   ...
   */
  Element* add_child_with_new_ns(const std::string& name,
    const std::string& ns_uri, const std::string& ns_prefix = std::string());
   ...
   *         or the child node or the namespace node cannot be created.
   */
  Element* add_child_with_new_ns(xmlpp::Node* previous_sibling, const std::string& name,
    const std::string& ns_uri, const std::string& ns_prefix = std::string());
   ...
   *         or the child node or the namespace node cannot be created.
   */
  Element* add_child_before_with_new_ns(xmlpp::Node* next_sibling, const std::string& name,
    const std::string& ns_uri, const std::string& ns_prefix = std::string());
   ...
   * @newin{2,36}
   */
  bool eval_to_boolean(const std::string& xpath, XPathResultType* result_type = 0) const;
   ...
   * @newin{2,36}
   */
  bool eval_to_boolean(const std::string& xpath, const PrefixNsMap& namespaces,
   ...
   * @newin{2,36}
   */
  double eval_to_number(const std::string& xpath, XPathResultType* result_type = 0) const;
   ...
   * @newin{2,36}
   */
  double eval_to_number(const std::string& xpath, const PrefixNsMap& namespaces,
    XPathResultType* result_type = 0) const;
   ...
   * @newin{2,36}
   */
  std::string eval_to_string(const std::string& xpath, XPathResultType* result_type = 0) const;
   ...
   * @newin{2,36}
   */
  std::string eval_to_string(const std::string& xpath, const PrefixNsMap& namespaces,
    XPathResultType* result_type = 0) const;
...
protected:
  ...
  ///Create the C instance ready to be added to the parent node.
  _xmlNode* create_new_child_node_with_new_ns(const std::string& name,
